    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/bbbb.jpg" alt="Image" width="300" height="1000">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown" style="margin-top: -150px;">Learning Today Leading
                            Tomorrow</h5>
                        <h3 class="display-1 text-white mb-md-4 animated zoomIn">Bus Facility</h3>
                             ...
                             <div style="border: dotted; border-radius: 20px;margin: 10px;">
                                <div>
                                    <p style="margin-left:25px; margin-top:20px;">
                                        ...
                                        Godavri Public School has a transport facility which comprises of a fleet of well-maintained buses, equipped with Global Positioning System [GPS] real time tracking and CCTV cameras as per government guidelines. The buses have been fitted with speed governors too. Each bus trip has a responsible school attendant on board to ensure safety of children. The bus staff have been sensitised to the school’s stance on student safety.
        ...
        <br>
<div>
   <center><h3>Bus Facility</h3></center> <br><br>
</div>
     
        <div class="row">
            <div class="column">
              <img src="img/bbb2.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/bbb3.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/bbb4.jpg" alt="Mountains" style="width:100%">
            </div>
            <div class="column">
                <img src="img/bbb5.jpg" alt="Mountains" style="width:100%">
              </div>
              <div class="column">
                <img src="img/bbb6.jpg" alt="Mountains" style="width:100%">
              </div>
              <div class="column">
                <img src="img/bbb7.jpg" alt="Mountains" style="width:100%">
              </div>
          </div>
         <br><br><br><br><br>
          <style>
