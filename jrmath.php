...
<body>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 'Numbers')" id="defaultOpen">Numbers</button>
      </div>
      
      <div id="Numbers" class="tabcontent">
        <h3 style="margin-left:300px"> 1. Numbers<br> &nbsp &nbsp (1 - 10)</h3><br><br>
        <img src="img/numbers.jpg" style="margin-left:100px; width: 600px;"><br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/DR-cfDsHCGA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:100px"></iframe>
