    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/playa.jpg" alt="Image" width="300" height="1000">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown" style="margin-top: -150px;">Learning Today Leading
                            Tomorrow</h5>
                        <h3 class="display-1 text-white mb-md-4 animated zoomIn">Play Area</h3>
                             ...
                             <div style="border: dotted; border-radius: 20px;margin: 10px;">
                                <div>
                                    <p style="margin-left:25px; margin-top:20px;">
                                        “Physical fitness is the first requisite of happiness”<br>
                                        Keeping in mind the importance of sports in every child’s life the school has provided two play areas for the students from Nursery to Std. X. Various Indoor as well as Outdoor activities / games are conducted. Also various competitions and matches are also conducted. The students are selected to represent the school for all DSO and other matches.
        ...
        <br>
<div>
   <center><h3>Play Area</h3></center> 
</div>
     
        <div class="row">
            <div class="column">
              <img src="img/play1.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/play2.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/play3.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
...
.column {
  ...
  .column {
    ...
    padding: 5px;
          ...
          <div class="row">
            <div class="column">
              <img src="img/play4.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/play5.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/play6.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
