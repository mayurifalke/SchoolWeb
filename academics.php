            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="computerlab1.html" class="dropdown-item">Computer Lab</a>
                        <a href="library1.html" class="dropdown-item">Library</a>
                        <a href="playarea1.html" class="dropdown-item">Play Area</a>
                        <a href="smartclass1.html" class="dropdown-item">Smart Classes</a>
    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img\t2.jpg" alt="Image" width="300" height="1000">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown" style="margin-top: -120px;">Learning Today Leading
                            Tommarow</h5>
                        <h3 class="display-1 text-white mb-md-4 animated zoomIn">Welcome to Godavari Public
                            School</h3>
                            <div style="text-align: center; ">
                                <h1 style="color:aqua;">Academics Achievements</h1>
                             </div><br><br>
                             <div style="border: dotted; border-radius: 20px;margin: 10px;">
                                <div>
                                    <p style="margin-left:25px; margin-top:20px;">
                                        The school believes in value based education and can boost of International standard facilities offered at an affordable cost.<br>
                        
                                        The school in a short span of time has grown in its strength with more than 1300 children under its umbrella from Nur to Std X primarily with the valuable support of great parents like you….<br>
                                        
                                        We are happy to announce that our 1st & 2nd batch of Std X students got 100% result in the CBSE board examination held in Mar 2018 & 2019.<br>
                                        
                                        Vigyan an International Science competition was organized by NPS Agara & 12 of our students had participated & won 3rd prize.<br>
...
<div class="row">
  <div class="column">
    <center>
    <div class="topper"><br><br>
        <h1>Our Toppers</h1>
            <br>
        <h3>First Topper</h3>
      <img src="img\tanisha.jpg" alt="Avatar" class="image1">
      <div class="overlay2">Tanisha S. Dharmaadhikari

          X STD Year 2020-2021
          
          She is one of our brightest students who scored 100.0%</div>
  </div></center>
  <style>
  ...
  <div class="column">
    ...
    <div class="topper">
        <h3>Second Topper</h3>
      <img src="img\gauri.jpg" alt="Avatar" class="image1">
      <div class="overlay2">Gauri G. Baheti

          X STD Year 2020-2021
          
          She is hardworking and smart student who scored 99.4%</div>
  ...
  <div class="column">
    ...
    <div class="topper">
        <h3>Third Topper</h3>
      <img src="img\pradyumna.jpg" alt="Avatar" class="image1">
      <div class="overlay2">Pradyumna P. Deshmukh

          X STD Year 2020-2021
          
          He is intelligent and have competitive sprit and scored 99%.</div>
