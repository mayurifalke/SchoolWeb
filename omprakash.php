   ...
   <!--<div class="tb1">
        <div class="row py-3">
            <div class="col-12 text-center" style="text-align: center;">
                <h1 class="display-3 text-white animated zoomIn" style="margin-left:580px;">Text Book List</h1>
                <a href="" class="h4 text-white"  style="margin-left:580px;">More</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Text Book List</a>
            </div>
        </div>--> 
    <!-- Hero End -->
<div class="tb1">
    ...
    <br><br><br>
    <div class="tbt">
    <h1 style="text-align: center; color:black;">Text Book Information<br> Classwise</h1><br><br><br><br>
    <table class="tabl" style="width: 40%";>
        <tr>
           <th style="text-align: center;color:black">Class</th>
            <th style="text-align: center; color:black;">Download</th>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Jr KG</td>
            <td><button onclick="location.href='file:///C:/xampp/htdocs/final%20project/jrkg.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Sr KG</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/srkg.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Nursery</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/nur1.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 1</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std1.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 2</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std2.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 3</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std3.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 4</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std4.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 5</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std5.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 6</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std6.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 7</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std7.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 8</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std8.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 9</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std9.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
        <tr>
            <td style="text-align: center; color:black;">Std 10</td>
            <td><button onclick="location.href='file:///C:/final%20project%201/std10.pdf';" style="margin-left:150px;">View File</button></td>
        </tr>
