    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/libr.jpg" alt="Image" width="300" height="1000">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown" style="margin-top: -150px;">Learning Today Leading
                            Tomorrow</h5>
                        <h3 class="display-1 text-white mb-md-4 animated zoomIn">Library</h3>
                             ...
                             <div style="border: dotted; border-radius: 20px;margin: 10px;">
                                <div>
                                    <p style="margin-left:25px; margin-top:20px;">
                                        "A book is a garden, an orchard, a storehouse, a party, a company by the way, a counsellor and a multitude of counsellors.”

                                        – Charles Baudelaire
                                        
                                        The school has a collection of around 6000 books that cover Fiction and Non-Fiction titles. In the reference section the library has Dictionaries, CBSE reference materials and Encyclopaedia which provides full support to the learners and the facilitators. To develop love and passion towards reading, the library has books on  Mythology, Brave hearts, Visionaries, Epics,  Fables, Humour, English Classics, Adventures, Detective stories, Philosophy and Novels. It is well-equipped with ergonomically designed furniture to facilitate easy search for students of different age groups.
                                        
                                        The school also subscribes to Newspapers in 3 languages, Magazines on science puzzles and Comic books on a regular basis.
                                    </p>
                                </div>
                    </div>
                </div>
...
<div>
   <center><h3>Library</h3></center> 
        ...
        <div class="row">
            <div class="column">
              <img src="img/lib1.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/lib2.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/lib3.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
...
.column {
  ...
  .column {
    ...
    padding: 5px;
          ...
          <div class="row">
            <div class="column">
              <img src="img/lib4.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/lib5.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/lib6.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
