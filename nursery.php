...
<div class="container-fluid p-0" style="height: 100%; width:100%">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" style="height: auto; width:100%">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/bgimg.jpg" alt="Image" style="height: auto; width:100%">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <center>
                        <h2 style="color: white;"> Subject of Nursery</h2><br><br><br>
                    </center>
                         <center>
                            <div class="cont">
                        <a href="language.php"><button class="b1">Language</button></a>
                        <a href="nmath.php"><button class="b2">Maths</button></a>
                        <a href="est.php"><button class="b3" style="">Environmental Science</button></a>
                    </div>
                       </center> 
            </div>
        </div>
