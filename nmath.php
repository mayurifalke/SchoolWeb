...
<body>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 'Pre-math Concepts')" id="defaultOpen">Pre-math Concepts</button>
        <button class="tablinks" onclick="openCity(event, 'Shapes')">Shapes</button>
        <button class="tablinks" onclick="openCity(event, 'Count')">Count</button>

      </div>
      
      <div id="Pre-math Concepts" class="tabcontent">
        <h3 style="margin-left:300px"> 1. Pre-math Concepts</h3><br><br>
        <img src="img/same.jpg" style="margin-left:150px; width: 600px;"><br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/fBcYFp6u5nw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:150px;"></iframe>
        
        </div>
      </div>
      
      <div id="Shapes" class="tabcontent">
        <h3 style="margin-left:300px">2. Shapes</h3><br>
        <img src="img/shapes.jpg" style="margin-left:200px; width: 600px;">
        <br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/BY5TkXOk2kQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:200px"></iframe>
        </div>
      </div>
      
      <div id="Count" class="tabcontent">
        <h3 style="margin-left:300px">2. Count</h3><br>
        <img src="img/count.jpg" style="margin-left:200px; width: 600px;">
        <br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/x6D51-pz2A4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:200px;"></iframe>
        </div>
      </div>
