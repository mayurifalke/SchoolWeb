    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="parent.html" class="nav-item nav-link active" style="color:black">Parent Login</a>
                <div class="nav-item dropdown">
...
<a href="logout.php"><input type="submit" value="LogOut" class="logout"></a>
 <!-- Team Start -->
 <div class="content1" style="margin-left:460px;margin-top:100px;background: rgba(240,227,227,0.5);
 backdrop-filter: blur(15px);">
 <div class="container-fluid pt-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 text-center team mb-5" style="margin-left: 30px;">
                <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                    <a href="StudentProfile.php"><img class="img-fluid w-100" src="img/p1.png" alt="" ></a>
                </div>
        ...
        <!--2nd row-->
            ...
            <div class="col-md-6 col-lg-3 text-center team mb-5" style="margin-left: 120px;">
                <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
