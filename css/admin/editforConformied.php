...
$selectquery="select * from adduser where id='$id' ";
...
<div class="main">
        ...
        <div class="contain" >
           ...
           <a href="conformiedUser.php"> <input type="button" value="Back"  name="reg"  id="sbtn2" ></a><br><br><br><br>
                    ...
                    <div class="details personal"><br>
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" placeholder="Your Password" style=" margin-left:20px;" required name="pass"
                                value="<?php echo $res['pass'];?>">
                            </div>
        
                            <div class="input-field">
                                <label style="margin-right: 40px;">Studentname</label>
                                <input type="text" placeholder=" Your name" required name="sname"
                                value="<?php echo $res['sname'];?>" style=" margin-right:20px;">
                            </div>
                            <div class="input-field">
...
$sql = "UPDATE adduser set pass='$pass',sname='$studentname',birth='$birth',adate='$adate',pemail='$email',gender='$gender',pno='$pno',addr='$addr' WHERE id='$id'";
