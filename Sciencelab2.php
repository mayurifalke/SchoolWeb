    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/1234567.jpg" alt="Image" width="" height="1000">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-3 animated slideInDown" style="margin-top: -150px;">Learning Today Leading
                            Tomorrow</h5>
                        <h3 class="display-1 text-white mb-md-4 animated zoomIn">Science Lab</h3>
                             ...
                             <div style="border: dotted; border-radius: 20px;margin: 10px;">
                                <div>
                                    <p style="margin-left:25px; margin-top:20px;">
                                        A science lab is a workplace for the conduct of scientific research. 
                                        It helps students to remember the concepts better and to transfer the experience to real-life 
                                        situations. It is a facility that provides controlled conditions in which scientific research, 
                                        experiments and measurements may be performed. Here at Godavari English Public School through labs 
                                        students are able to – *Understand the complexity and ambiguity of empirical work. *Develop practical skills. 
                                        *Collaborate and work as a team which helps to cultivate interest in science. SCIENCE LAB: Our physics lab is aimed 
                                        in enabling student to learn physics theories in a more elaborative manner of its applications CHEMISTRY LAB: The chemistry lab is 
                                        designed with keeping all the statutory norms and safety standards. It is well ventilated as well as spacious. BIOLOGY LAB: 
                                        In the biology lab, the students study detailed structures, 
                                        morphological, histological and physiological aspects of plants and animals.
                                    </p>
                                </div>
                    </div>
                </div>
        ...
        <br>
<div>
   <center><h3>Science lab Gallery</h3></center> 
</div>
     
        <div class="row">
            <div class="column">
              <img src="img/science1.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/science3.jpg" alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/science2.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
...
.column {
  ...
  .column {
    ...
    padding: 5px;
          ...
          <div class="row">
            <div class="column">
              <img src="img/science4.jpg" alt="Snow" style="width:100%">
            </div>
            <div class="column">
              <img src="img/science5.jpg." alt="Forest" style="width:100%">
            </div>
            <div class="column">
              <img src="img/science6.jpg" alt="Mountains" style="width:100%">
            </div>
          </div>
