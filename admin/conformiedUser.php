...
<div class="form-popup" id="myForm">
  <form action="#" class="form-container" method="post" enctype="multipart/form-data">
   ...
   <input type="file" name="uploadfile">
    ...
    <input type="date" placeholder="Enter DOB" name="birth" required>

    <label><b>Admission Date</b></label>
    <input type="date" placeholder="Enter Admission Date" name="adate" required>

    <label><b>Parent EmailID</b></label>
    <input type="text" placeholder="Enter EmailID" name="pemail" required>

    <label><b>Gender</b></label>
    <input type="text" placeholder="Enter Gender" name="gender" required>

    <label><b>Parent No</b></label>
    <input type="number" placeholder="Enter Father No" name="pno" required>
...
if(isset($_POST['reg']))
{
 /* $filename = basename($_FILES["uploadfile"]["name"]);
  ...
  echo $folder;
  //$name1=basename($_FILES["uploadfile"][])
  //echo $folder;
...
$sql = "INSERT INTO adduser (pass,sname,birth,adate,pemail,gender,pno,addr,uimg,imgdata2) 
VALUES ('$pass','$studentname', '$birth','$adate','$pemail','$gender','$pno','$addr','$folder','$image_file')";

if (mysqli_query($con, $sql)) 
{
    //move_uploaded_file($_FILES["simage"]["tmp_name"],"upload/".$_FILES["simage"]["name"]);
    //$_SESSION['status']="Image stored successfully";
    //header('Location:conformiedUser.php');
