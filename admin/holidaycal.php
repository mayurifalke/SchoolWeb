        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">School Holidays Calendar</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card">
    ...
    <button class="open-button" onclick="openForm()">Add Holidays</button>

<div class="form-popup" id="myForm">
  <form action="#" class="form-container" method="post" enctype="multipart/form-data">
   <!-- <h1>Login</h1>-->
   
    <label><b>Day of Date</b></label>
    <input type="text"  name="day" required>

    <label><b>Date</b></label>
    <input type="date"  name="date" required>

    <label><b>Name of Holiday</b></label>
    <input type="text" placeholder="Enter Holiday" name="name" required>
...
$sql = "INSERT INTO addholidays (day,date,name) VALUES ('$day','$date','$name')";
