...
$selectquery="select * from registration2 where id='$id' ";
...
<div class="main">
        ...
        <div class="contain" >
           ...
           <a href="register.php"> <input type="button" value="Back"  name="reg"  id="sbtn2" ></a><br><br><br><br>
                    ...
                    <div class="details personal"><br>
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" placeholder="Your Name" style=" margin-left:20px;" required name="studentname"
                                value="<?php echo $res['studentname'];?>">
                            </div>
                            <div class="input-field">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" placeholder="Your Gender" required name="gender" style=" margin-left:20px;"
...
$sql = "UPDATE registration2 set studentname='$studentname',birth='$birth',email='$email',gender='$gender',fatherNo='$fno',nation='$nation',
mothertongue='$tongue',fathername='$fname' WHERE id='$id'";
