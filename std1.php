...
<body>
    ...
    <br><br>
    <center>
        <h2> Subject of Standard 1</h2><br>
    </center>
          
        <a href="std1Eng.html"><button class="b1">English</button></a>
        <button class="b2">Marathi</button>
        <button class="b3">Hindi</button>
        <button class="b4">Math</button>
