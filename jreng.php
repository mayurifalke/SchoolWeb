...
<body>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 'Alphabets')" id="defaultOpen">Alphabets</button>
        <button class="tablinks" onclick="openCity(event, 'Vowels')">Vowels</button>
      </div>
      
      <div id="Alphabets" class="tabcontent">
        <h3 style="margin-left:300px"> 1. Alphabets</h3><br><br>
        <img src="img/alphabets.jpg" style="margin-left:150px; width: 600px;"><br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/hq3yfQnllfQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:150px;"></iframe>
        
        </div>
      </div>
      
      <div id="Vowels" class="tabcontent">
        <h3 style="margin-left:300px">2. Vowels</h3>
        <img src="img/vowels.jpg" style="margin-left:200px">
        <br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/arQxkdRYyE4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:200px"></iframe>
        </div>
      </div>
