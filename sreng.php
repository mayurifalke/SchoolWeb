...
<body>
    ...
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 'Letter Sounds')" id="defaultOpen">Letter Sounds</button>
        <button class="tablinks" onclick="openCity(event, 'Rhymes & Poems')">Rhymes & Poems</button>
      </div>
      
      <div id="Letter Sounds" class="tabcontent">
        <h3 style="margin-left:300px"> 1. Letter Sounds</h3><br><br>
        <img src="img/letter.jpg" style="margin-left:150px; width: 600px;"><br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/g0SFjRzqj94" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:150px;"></iframe>
        </div>
      </div>
      
      <div id="Rhymes & Poems" class="tabcontent">
        <h3 style="margin-left:300px">2. Rhymes & Poems</h3>
        <img src="img/Rhyme.jpg" style="margin-left:200px">
        <br><br><br>
        <div class="v1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Zu6o23Pu0Do" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-left:200px;"></iframe>
        </div>
      </div>
