...
<!-- Full Screen Search End -->
    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center" style="margin-left: 400px;">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s">
                    <div class="bg-light rounded h-100 p-5">
                        <div class="section-title">
                            <h5 class="position-relative d-inline-block text-primary text-uppercase">GET IN TOUCH</h5>
                            <h1 class="display-6 mb-4">Contact Us For Any Query</h1>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="bi bi-geo-alt fs-1 text-primary me-3"></i>
                            <div class="text-start">
                                <h5 class="mb-0">Address</h5>
                                <span>Waluj,Aurangabad,431001</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                ...
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="#" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Message" name="msg"></textarea>
                            </div>
                            <div class="col-12">
                ...
                <iframe class="position-relative rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60050.752123780556!2d75.19974146918562!3d19.83267362621279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdb9bc36aa14927%3A0xbe9f87b5b93017e4!2sWaluj%2C%20Aurangabad%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1679376907864!5m2!1sen!2sin" 
...
$sql = "INSERT INTO contact (fname,email,sub,msg) VALUES ('$Name','$email','$sub','$msg')";
