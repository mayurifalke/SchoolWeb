        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center" style="background-color: #0000008a;">
                    <center>
                        <h2 style="color: white;"> Subject of Jr.Kg</h2><br>
                    </center>
                      <center>    
                        <a href="jreng.php"><button class="b1">English</button></a>
                        <a href="jrmath.html"><button class="b2">Maths</button></a>
                    </center>
            </div>
        </div>
        </div>
